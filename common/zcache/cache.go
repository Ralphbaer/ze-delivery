...
// Item represents any object that can be stored as value and its expiration time
type Item struct {
	Object     interface{}
	Expiration int64
}
...
const (
	// NoExpiration is used with functions that take an expiration time.
...
// Cache abstracts the private cache struct
type Cache struct {
	*cache
